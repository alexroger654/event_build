...
import { createData, getData, updateData } from "@/lib/commonFunctions";
...
export default function CreateEventPage() {
  ...
  useEffect(() => {
    ...
    getData(setEventData, `event/list?id=${params?.id}`, setLoading);
  }, []);
      ...
      <div className="mx-auto grid max-w-[89rem] flex-1 auto-rows-max gap-4">
        ...
        <div className="grid gap-4 md:grid-cols-[1fr_250px] lg:grid-cols-3 lg:gap-8">
          ...
          <div className="grid auto-rows-max items-start gap-4 lg:gap-8">
            ...
            <Card className="overflow-hidden" x-chunk="dashboard-07-chunk-4">
              <CardHeader>
                <CardTitle>View User List</CardTitle>
                <CardDescription>
                  Lipsum dolor sit amet, consectetur adipiscing elit
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid gap-2">
                  <div className="w-full gap-2 capitalize">
                    <Link href={`/admin/events/user_list/${eventData?._id}`}>
